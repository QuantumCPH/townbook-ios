...
#import "ChatMessgaeSendCell.h"

#define kGreenLeftCapWidth  14
#define kTopCapHeight    15

@implementation ChatMessgaeSendCell
...
-(void)loadData:(NSString *)msgTxt{
    ...
    self.bubbleImgView.image=[[UIImage imageNamed:@"chat_right.png"] stretchableImageWithLeftCapWidth:kGreenLeftCapWidth
