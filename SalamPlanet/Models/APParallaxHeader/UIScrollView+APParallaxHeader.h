...
- (void)addParallaxWithoutButtonWithImage:(UIImage *)image andHeight:(CGFloat)height andShadow:(BOOL)shadow ;//By Saad
...
- (void)parallaxViewAddPhotoButtonPressed;//By Saad
@end
