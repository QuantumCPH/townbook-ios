...
- (void)addCenterGestureRecognizers
{
    if (self.centerViewController)
    {
        ...
        [[self.centerViewController view] addGestureRecognizer:[self panGestureRecognizer]];//Saad for removing the tap gesture for slide menu
    }
}
...
#pragma mark-Custom Method By Saad
-(void)addPanGestureRecognizerForSlideMenu{
    if (self.centerViewController) {
        [[self.centerViewController view] addGestureRecognizer:[self panGestureRecognizer]];//Saad
    }
}
-(void)removePanGestureRecognizerForSlideMenu{
    if (self.centerViewController) {
        [[self.centerViewController view] removeGestureRecognizer:[self panGestureRecognizer]];//Saad
    }
}
#pragma mark -
...
- (void)openLeftSideMenuCompletion:(void (^)(void))completion {
    ...
    if ([self.leftMenuViewController isKindOfClass:[EndrMenuViewController class]]) {//Saad
        [(EndrMenuViewController *)self.leftMenuViewController viewWillAppearOnScreen];
    }
...
- (void)setMenuState:(MFSideMenuState)menuState {
    if (menuState) {
        [self addPanGestureRecognizerForSlideMenu];
    }
    else{
        [self removePanGestureRecognizerForSlideMenu];
    }
