...
#define COLOR_WATER_BLUE [UIColor colorWithString:@"#FFFFFF"]//49BD8F//#E0EAF4

#define DEFAULT_LABEL_BACKGROUND_COLOR [UIColor lightGrayColor]
#define DEFAULT_LABEL_TEXT_COLOR [UIColor colorWithString:@"#49BD8F"]
...
#define DEFAULT_LABEL_GRANITEN_COLORS @[COLOR_WATER_BLUE]//@[ COLOR_WATER_BLUE, [COLOR_WATER_BLUE darken:.02f], [UIColor whiteColor]]
...
@property (nonatomic, GC_STRONG) UIImageView* frameView;
...
- (id)initReuseIdentifier:(NSString *)identifier {
    ...
    if (self) {
        ...
        self.gradientLayer.borderWidth = 0.0f;
...
- (void)setLabelText:(NSString *)text accessoryType:(GCTagLabelAccessoryType)type {
    ...
    if (!self.label) {
        ...
        self.frameView.image=[UIImage imageNamed:@"Tag-box"];
...
- (void)resizeLabel {
    ...
    self.frameView.frame=self.frame;
    self.gradientLayer.frame = self.bounds;
//    self.gradientLayer.borderColor=(__bridge CGColorRef)([UIColor blueColor]);
