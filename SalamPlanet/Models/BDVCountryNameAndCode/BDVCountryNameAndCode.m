...
- (NSString*)countryNameFromCountryShortName:(NSString*)countryShortName
{
    NSString *prefix = [dictDialingCodes objectForKey:countryShortName];
    NSInteger indexOfPrefixAtCountryNamesArray = [prefixDialingCodes indexOfObject:prefix];
...
- (NSNumber*)getPrefixFromCountryShortName:(NSString*)countryShortName
{
    NSNumber *prefix = [dictDialingCodes objectForKey:countryShortName];
