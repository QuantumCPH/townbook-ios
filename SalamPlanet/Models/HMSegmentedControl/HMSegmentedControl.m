...
-(void)updateTheImageArray:(NSArray *)array{//By Saad
...
- (void)commonInit {
    ...
    self.textColor = [UIColor colorWithRed:135.0/255.0 green:93.0/255.0 blue:169.0/255.0 alpha:1];//[UIColor colorWithRed:73.0/255.0 green:189.0/255.0 blue:143.0/255.0 alpha:1.0];
    self.selectedTextColor = [UIColor whiteColor];
    self.backgroundColor = [UIColor whiteColor];
    self.opaque = NO;
    self.selectionIndicatorColor =[UIColor clearColor];// [UIColor colorWithRed:52.0f/255.0f green:181.0f/255.0f blue:229.0f/255.0f alpha:1.0f];
    
    self.selectedSegmentIndex = 0;
    self.segmentEdgeInset = UIEdgeInsetsMake(0, 0, 0, 0);//(0,5,0,5)
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type == HMSegmentedControlTypeText) {
		...
		[self.sectionImages enumerateObjectsUsingBlock:^(id iconImage, NSUInteger idx, BOOL *stop) {
            ...
            CGRect imageRect = CGRectMake(imageXOffset, 5, imageWidth, imageHeight);//By Saad
...
//            CGRect textRect = CGRectMake(textXOffset, yOffset, [[self.segmentWidthsArray objectAtIndex:idx] floatValue]-imageWidth-segmentImageTextPadding-self.segmentEdgeInset.left-self.segmentEdgeInset.right, stringHeight);
            CGRect textRect=imageRect;//By Saad
            textRect.origin.y+=8;//By Saad
            if (_isFromContactScreen && idx==0){
                textRect.origin.x-=8;
            }
            else if(_isFromContactScreen && idx==1)
            {
