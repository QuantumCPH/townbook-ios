...
//            return;
    ...
    NSMutableDictionary *attr = [[NSMutableDictionary alloc] initWithDictionary:@{NSFontAttributeName : [UIFont boldSystemFontOfSize:15.0]}];//[self defaultAttributedString]];
...
{
//    NSLog(@"%@",@{NSFontAttributeName : self.font});
    if(self.font){
