...
@interface PTSMessagingCell : UITableViewCell <PPLabelDelegate>{
...
@property (nonatomic, readonly) UILabel * statusLabel;//Saad
@property (nonatomic, readonly) UIImageView * timeLabelBG;

@property (nonatomic, readonly) UIImageView * avatarImageView;

@property (nonatomic, readonly) UIImageView * avatarImageViewOuterFrame;
