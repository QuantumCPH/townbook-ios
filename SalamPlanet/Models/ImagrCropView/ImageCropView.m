...
- (void)viewDidLoad
{
    ...
    if (self){
        ...
        self.navigationController.navigationBar.tintColor=[UIColor colorWithRed:102.0/255.0 green:51.0/255.0 blue:153.0/255.0 alpha:1];
        CGRect view = CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height );//- [[self navigationController] navigationBar].bounds.size.height);By Saad
...
- (void)setImage:(UIImage *)image {
    ...
    imageFrameInView = CGRectMake(0,0,frameWidth,frameHeight);//CGRectMake(x, y, scaledImageWidth, scaledImageHeight);Saaf
    imageView.frame = imageFrameInView;
